...
-------------------------------Correciones Práctica06-----------------------------------------------------
/*
- Se organiza la creación de tablas de la siguiente manera, destacando que no se hizo ninguna modificación directa a 
lo ya enviado en la práctica05, sino que unicamente se reacomodó el orden de las tablas para corroborar
la creación de todas junto con sus integridades.

IMPORTANTE: Algunas correcciones se agregan al final del documento puesto que no se ejecutaba el script de manera adecuada en caso contrario.
...
(10) Recepcionista
(11) limpiezaInterna
(12) telefonoServicioComida
(13) telefonoRecepcionista
(14) telefonoPersonalApoyo
(15) telefonoLimpiezaInterna
(16) correoPersonalApoyo
(17) correoServicioComida
(18) correoRecepcionista
(19) correoLimpiezaInterna
(20) individual
(21) doble
(22) cuadruple
(23) penthouse
...
(28) pago
(29) servicioExtra
(30) disponerIndividual
(31) disponerDoble
(32) disponerCuadruple
(33) disponerPenthouse
(34) atender
(35) rentarIndividual
(36) rentarDoble
(37) rentarCuadruple
...
- Se agrega tabla realizarPago
- Se cambia nombre de idDisponerInvidual, idDisponerDoble, idDisponerCuadruple 
e idDisponerPenthouse a idHabitacion para que hagan sentido con las referencias en las tablas DISPONER.
- Se modifican los CONSTRAINT NumeroNinos_check, NumeroAdultos_check, NumeroMascotas_check, 
NumeroNoches_check para que también pueda ingresarse el valor de 0.
- Se borra la columna idPago de la tabla huesped.
*/
